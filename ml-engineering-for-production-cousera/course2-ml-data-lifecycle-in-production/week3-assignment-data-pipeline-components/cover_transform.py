...
_SCALE_MINMAX_FEATURE_KEYS = cover_constants.SCALE_MINMAX_FEATURE_KEYS  # "Horizontal_Distance_To_Hydrology", "Vertical_Distance_To_Hydrology"
_SCALE_01_FEATURE_KEYS = cover_constants.SCALE_01_FEATURE_KEYS # "Hillshade_9am", "Hillshade_Noon", "Horizontal_Distance_To_Fire_Points"
_SCALE_Z_FEATURE_KEYS = cover_constants.SCALE_Z_FEATURE_KEYS  # "Elevation", "Slope", "Horizontal_Distance_To_Roadways",
_VOCAB_FEATURE_KEYS = cover_constants.VOCAB_FEATURE_KEYS  # "Wilderness_Area"
_HASH_STRING_FEATURE_KEYS = cover_constants.HASH_STRING_FEATURE_KEYS  # "Soil_Type"
_LABEL_KEY = cover_constants.LABEL_KEY  # "Cover_Type"
_transformed_name = cover_constants.transformed_name  # key + '_xf'
...
def preprocessing_fn(inputs):
    ...
    for feature in _HASH_STRING_FEATURE_KEYS:
        ...
        features_dict[_transformed_name(feature)] = tft.hash_strings(strings=data_col,
                                                                     hash_buckets=10)
